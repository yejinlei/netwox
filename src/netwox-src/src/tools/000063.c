...
/*-------------------------------------------------------------*/
netwib_conststring t000063_description[] = {
...
netwox_tooltreenodetype t000063_nodes[] = {
  NETWOX_TOOLTREENODETYPE_TRACEROUTE,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000063_info = {
...
netwib_err t000063_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000063_info, &parg));
  ...
  /* main loop */
  netwib_er(netwox_tracert_loop(NETWOX_TRACERT_METHOD_PROTO, &dstip,
                                &addinfo, NULL));

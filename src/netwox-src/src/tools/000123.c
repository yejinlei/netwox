...
/*-------------------------------------------------------------*/
netwib_conststring t000123_description[] = {
...
netwib_err t000123_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000123_info, &parg));
  ...
  /* request */
  netwib_er(netwox_httpcli_trace(&ctx, &url, &statuscode, phdrio, pbodyio));
  if (displaystatus) {

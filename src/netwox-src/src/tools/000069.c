...
/*-------------------------------------------------------------*/
netwib_conststring t000069_description[] = {
...
netwox_tooltreenodetype t000069_nodes[] = {
  NETWOX_TOOLTREENODETYPE_SCAN,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000069_info = {
  "Scan UDP",
  t000069_description,
  "nmap",
  t000069_args,
...
netwib_err t000069_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000069_info, &parg));
  ...
  /* main loop */
  netwib_er(netwox_scan_loop(NETWOX_SCAN_METHOD_UDP, &info));

...
/*-------------------------------------------------------------*/
netwib_conststring t000119_description[] = {
...
netwox_tooltreenodetype t000119_nodes[] = {
  NETWOX_TOOLTREENODETYPE_CLIENT_TCP_HTTP,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000119_info = {
  "HTTP HEAD",
  t000119_description,
  "web",
  t000119_args,
...
netwib_err t000119_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000119_info, &parg));
  ...
  /* request */
  netwib_er(netwox_httpcli_head(&ctx, &url, &statuscode, phdrio));
  if (displaystatus) {

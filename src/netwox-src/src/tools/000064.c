...
/*-------------------------------------------------------------*/
netwib_conststring t000064_description[] = {
  NETWOX_DESC_traceroute,
  NETWOX_DESC_pts_proto,
  NETWOX_DESC_pts_ether,
  NETWOX_DESC_toolpriv_snsp,
  NULL
};
netwox_toolarg t000064_args[] = {
  ...
  NETWOX_TOOLARG_OPT_UINT32('p', "protocol", "ip protocol", "1"),
  NETWOX_TOOLARG_OPT_BUF_MIXED('D', "ip4-data", NULL, NULL),
  ...
  NETWOX_TOOLARG_OPTA_BOOL('r', "resolve", "resolve hostname", NULL),
  NETWOX_TOOLARG_END
};
netwox_tooltreenodetype t000064_nodes[] = {
  NETWOX_TOOLTREENODETYPE_TRACEROUTE,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000064_info = {
...
netwib_err t000064_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000064_info, &parg));
  ...
  netwib_er(netwox_arg_uint32(parg, 'p', (netwib_uint32*)&addinfo.ipproto));
  netwib_er(netwox_arg_buf(parg, 'D', &addinfo.ipdata));
  ...
  /* main loop */
  netwib_er(netwox_tracert_loop(NETWOX_TRACERT_METHOD_PROTO_ETHIPSPOOF,
                                &dstip, &addinfo, NULL));

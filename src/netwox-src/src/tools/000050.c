...
/*-------------------------------------------------------------*/
netwib_conststring t000050_description[] = {
  NETWOX_DESC_ping,
...
netwox_tooltreenodetype t000050_nodes[] = {
  NETWOX_TOOLTREENODETYPE_PING,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000050_info = {
...
netwib_err t000050_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000050_info, &parg));
  ...
  /* main loop */
  netwib_er(netwox_ping_loop(NETWOX_PING_METHOD_PING_ETHIPSPOOF,
                             &dstip, &addinfo));

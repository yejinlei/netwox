...
/*-------------------------------------------------------------*/
netwib_conststring t000056_description[] = {
  NETWOX_DESC_ping,
  NETWOX_DESC_pts_arp,
...
netwox_tooltreenodetype t000056_nodes[] = {
  NETWOX_TOOLTREENODETYPE_PING,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000056_info = {
...
netwib_err t000056_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000056_info, &parg));
  ...
  /* main loop */
  netwib_er(netwox_ping_loop(NETWOX_PING_METHOD_ARP_ETHIPSPOOF,
                             &dstip, &addinfo));

...
/*-------------------------------------------------------------*/
netwib_conststring t000043_description[] = {
...
netwox_tooltreenodetype t000043_nodes[] = {
...
netwib_err t000043_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000043_info, &parg));
  ...
  netwib_er(netwox_ip4opts_pkt_noop(&ip4opts));

...
/*-------------------------------------------------------------*/
netwib_conststring t000058_description[] = {
...
netwox_tooltreenodetype t000058_nodes[] = {
  NETWOX_TOOLTREENODETYPE_TRACEROUTE,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000058_info = {
...
netwib_err t000058_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000058_info, &parg));
  ...
  /* main loop */
  netwib_er(netwox_tracert_loop(NETWOX_TRACERT_METHOD_PING_ETHIPSPOOF,
                                &dstip, &addinfo, NULL));

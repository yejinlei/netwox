...
/*-------------------------------------------------------------*/
netwib_conststring t000045_description[] = {
...
netwox_toolarg t000045_args[] = {
  ...
  NETWOX_TOOLARG_OPT_IPS_U('i', "ip4opt-ips", "IP addresses for LSRR",
                           "1.2.3.4,5.6.7.8"),
  NETWOX_TOOLARG_END
};
netwox_tooltreenodetype t000045_nodes[] = {
...
netwib_err t000045_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000045_info, &parg));
  ...
  netwib_er(netwox_ip4opts_pkt_lsrr(pips, &ip4opts));

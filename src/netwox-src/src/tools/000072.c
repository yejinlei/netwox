...
/*-------------------------------------------------------------*/
netwib_conststring t000072_description[] = {
...
netwox_tooltreenodetype t000072_nodes[] = {
  NETWOX_TOOLTREENODETYPE_SCAN,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000072_info = {
...
netwib_err t000072_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000072_info, &parg));
  ...
  /* main loop */
  netwib_er(netwox_scan_loop(NETWOX_SCAN_METHOD_ARP_ETHIPSPOOF, &info));

...
/*-------------------------------------------------------------*/
netwib_conststring t000062_description[] = {
...
netwox_tooltreenodetype t000062_nodes[] = {
  NETWOX_TOOLTREENODETYPE_TRACEROUTE,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000062_info = {
...
netwib_err t000062_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000062_info, &parg));
  ...
  /* main loop */
  netwib_er(netwox_tracert_loop(NETWOX_TRACERT_METHOD_UDP_ETHIPSPOOF,
                                &dstip, &addinfo, NULL));

...
/*-------------------------------------------------------------*/
netwib_conststring t000086_description[] = {
...
netwox_toolarg t000086_args[] = {
  ...
  NETWOX_TOOLARG_OPTA_UINT32('c', "code", "ICMP code", NULL),
  NETWOX_TOOLARG_OPTA_IP_SRC('i', NULL, NULL, NULL),
  NETWOX_TOOLARG_REQ_IP('g', "gw", "new gateway", NULL),
  NETWOX_TOOLARG_END
};
netwox_tooltreenodetype t000086_nodes[] = {
  NETWOX_TOOLTREENODETYPE_NETAUDIT_ICMP,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000086_info = {
...
netwib_err t000086_core(int argc, char *argv[])
{
  ...
  netwib_er(netwox_arg_init(argc, argv, &t000086_info, &parg));

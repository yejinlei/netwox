...
/*-------------------------------------------------------------*/
netwib_conststring t000140_description[] = {
  NETWOX_DESC_spoof_packet,
  NETWOX_DESC_toolpriv_spoof,
  NULL
};
netwox_toolarg t000140_args[] = {
  ...
  NETWOX_TOOLARG_OPTA_UINT32('m', "eth-type", "Ethernet type", "2048"),
...
{
  netwox_arg *parg;
  netwib_buf device, buf, ip6data, pkt, pkt2;
  netwib_io *pio;
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000140_info, &parg));

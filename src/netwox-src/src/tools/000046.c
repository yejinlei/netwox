...
/*-------------------------------------------------------------*/
netwib_conststring t000046_description[] = {
...
netwox_tooltreenodetype t000046_nodes[] = {
...
netwib_err t000046_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000046_info, &parg));
  ...
  netwib_er(netwox_ip4opts_pkt_ts(&ip4opts));

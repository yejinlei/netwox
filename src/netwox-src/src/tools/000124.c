...
/*-------------------------------------------------------------*/
netwib_conststring t000124_description[] = {
...
netwox_tooltreenodetype t000124_nodes[] = {
  NETWOX_TOOLTREENODETYPE_CLIENT_TCP_HTTP,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000124_info = {
  "HTTP OPTIONS",
  t000124_description,
  "web",
  t000124_args,
...
netwib_err t000124_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000124_info, &parg));
  ...
  /* request */
  netwib_er(netwox_httpcli_options(&ctx, &url, &statuscode, phdrio));
  if (displaystatus) {

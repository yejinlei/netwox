...
/*-------------------------------------------------------------*/
netwib_conststring t000122_description[] = {
...
netwox_tooltreenodetype t000122_nodes[] = {
  NETWOX_TOOLTREENODETYPE_CLIENT_TCP_HTTP,
  NETWOX_TOOLTREENODETYPE_END
};
netwox_tool_info t000122_info = {
  "HTTP DELETE",
  t000122_description,
  "web",
  t000122_args,
...
netwib_err t000122_core(int argc, char *argv[])
{
  ...
  /* obtain parameters */
  netwib_er(netwox_arg_init(argc, argv, &t000122_info, &parg));
  ...
  /* request */
  netwib_er(netwox_httpcli_delete(&ctx, &url, &statuscode, phdrio));
  if (displaystatus) {

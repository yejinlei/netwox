...
#define OID_FDDI_PORT_CONNECT_STATE			0x03030272
...
typedef struct _WW_CDPD_CIRCUIT_SWITCHED {
    ...
    //   the CS CDPD implement guidelines.
    ...
    UINT receive_timer;		//  secs. per CS-CDPD Implement Guidelines.

    UINT conn_resp_timer;	//  secs. per CS-CDPD Implement Guidelines.

    UINT reconn_resp_timer;	//  secs. per CS-CDPD Implement Guidelines.

    UINT disconn_timer;		//  secs. per CS-CDPD Implement Guidelines.

    UINT NEI_reg_timer;		//  secs. per CS-CDPD Implement Guidelines.

    UINT reconn_retry_timer;	//  secs. per CS-CDPD Implement Guidelines.

    UINT link_reset_timer;	//  secs. per CS-CDPD Implement Guidelines.

    UINT link_reset_ack_timer;	//  secs. per CS-CDPD Implement Guidelines.

    UINT n401_retry_limit;	//  per CS-CDPD Implement Guidelines.

    UINT n402_retry_limit;	//  per CS-CDPD Implement Guidelines.

    UINT n404_retry_limit;	//  per CS-CDPD Implement Guidelines.

    UINT n405_retry_limit;	//  per CS-CDPD Implement Guidelines.
